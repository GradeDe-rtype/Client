...
#ifndef RTYPE_GAME_SETTINGS_GENERAL_MINI_SCENE_HPP_
#define RTYPE_GAME_SETTINGS_GENERAL_MINI_SCENE_HPP_
    ...
    namespace Game
    {
        namespace Scenes
        {
            namespace MiniScene
            {
                namespace Settings
                {
                    class GeneralMiniScene : public AMiniScene
                    {
                        public:
...
#endif /* !RTYPE_GAME_SETTINGS_GENERAL_MINI_SCENE_HPP_ */
