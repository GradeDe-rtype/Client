        ...
        namespace Scenes
        {
            namespace MiniScene
            {
                namespace Settings
                {
                    ...
                    void AccessibilityMiniScene::load(gd::Vector2<float> coord, gd::Vector2<float> window)
                    {
                        _coord = coord;
                        _window = window;
                    ...
                    void AccessibilityMiniScene::reload(gd::Vector2<float> coord, gd::Vector2<float> window)
                    {
                        _coord = coord;
                        _window = window;
                    ...
                    void AccessibilityMiniScene::draw(gd::Window &window)
                    {
                        for (auto &section : _sections)
                            section->draw(window);
                        _save->draw(window);
                    ...
                    void AccessibilityMiniScene::_changeRangeValue(int value)
                    {
                    ...
                    void AccessibilityMiniScene::_moveSelected(int value)
                    {
                    ...
                    void AccessibilityMiniScene::_saveSettings()
                    {
